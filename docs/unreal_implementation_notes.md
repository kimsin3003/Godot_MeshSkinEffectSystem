...
latest benchmark:  hits=8 raycast_ms=7.792  event_ms=0.228  full_ms=8.021
```
...
sand latest:    sand_step_ms=8.755,2.004,4.596,5.272,4.351,1.048,0.968,0.549
sand frames:    sand_frame_avg_ms=2.367 sand_frame_max_ms=8.795
```
